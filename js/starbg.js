...
var redYlimt=-0.35*canvasElement.width*0.22;;
 function draw(){
     ...
     // 顶部渐变颜色
     colors.addColorStop(0,"#3dbe71");
     // colors.addColorStop(0.75,"#090723");
     // 中部渐变颜色
     colors.addColorStop(0.75,"#fcb334");
     // colors.addColorStop(1,"#08071e")
     // 底部渐变颜色
     colors.addColorStop(1,"#6976f3")
     ...
     // 中部的圆圈
     drawCircle("#28e3e8",canvasElement.width*0.025,0.95*canvasElement.width,0.32*canvasElement.height);
     // drawCircle("#140c2a",canvasElement.width*0.01,0.75*canvasElement.width,0.22*canvasElement.height);        //紫
     // 上方的圆圈
     drawCircle("#ff5237",canvasElement.width*0.01,0.75*canvasElement.width,0.22*canvasElement.height);
     //drawCircle("#090929",canvasElement.width*0.018,0.82*canvasElement.width,0.52*canvasElement.height);       //蓝
     // 下方的圆圈
     drawCircle("#dbe2f9",canvasElement.width*0.018,0.82*canvasElement.width,0.52*canvasElement.height);
     if(redstart==true){
         redYlimt+=1;
     }
     if(redYlimt>yred){
